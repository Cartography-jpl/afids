...
{
       0,     0,     3,     4,     7,     9,    11,    16,    23,    25
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      11,     0,    -1,    -1,    11,    12,    -1,     7,    -1,     3,
      -1,     4,     5,     4,     7,    -1,     4,     5,     8,    13,
       9,     7,    -1,     4,    -1,    13,     6,     4,    -1
};
...
{
  "$end", "error", "$undefined", "COMMENT", "TOKEN", "EQUALS", "COMMA",
  "EOL", "LBRACE", "RBRACE", "$accept", "rules", "rule", "values", 0
};
#endif
