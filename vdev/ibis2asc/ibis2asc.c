...
//#include "cartoVicarProtos.h"    /* cartlab only - zifmessage */
...
void main44(void)
{
   int i,j,k,i_unit,status,clen,ncol,nr,sr,ibis,dummy,parmct,parmdf,blnkout;
   int colcount,coldef,cquote,cols[MAXCOLS],wid[MAXCOLS],totwid,uwid;
   char infilename[256],sep[2],fmtstring[10],ctype[MAXCOLS],*cbuf,*pbuf;
   double **buf,penupval,testval;
   FILE *mifcb1;
   
   zvmessage("ibis2asc - Jul 02 2012 - 64-bit - rjb"," ");
