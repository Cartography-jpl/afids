...
OBJS = dbfopen.o shpopen.o MemUtils.o fileutils.o LPUtils.o mappingUtils.o lppixmap.o

INCLUDES =

CLEANOBJS = dbfopen.o shpopen.o MemUtils.o fileutils.o LPUtils.o mappingUtils.o lppixmap.o

CLEANSRC = dbfopen.c shpopen.c MemUtils.c fileutils.c LPUtils.c mappingUtils.c lppixmap.c
...
system: lppixmap doc clean.obj clean.src

compile:  $(OBJS)

lppixmap:  $(OBJS)
	$(LINK.c) -o lppixmap $(OBJS) $(LIBS)
