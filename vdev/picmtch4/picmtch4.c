   ...
   double trans[12];
{
   ...
   for (i=0;i<nlbx;i++)
      {
      status = zvread(i_unit[filenum-1],imbuf[i],
...
void main44(void)
{
   ...
   int pcount,pdef,unit,status,ibis,parmcnt,o_unit,labnl,labns,fftsize;
   int choplimit1,choplimit2,bigchoplimit2,nredo,maxredo,ibigx,predfunc;   
   float retryparm[3];
   char *labelstr,magshrk[2];
   
   zifmessage("picmtch4 version Thu Dec 22 2011");
