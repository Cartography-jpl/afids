...
void main44(void)
{
   ...
   double real_result;
   char *p,*q,char_result[MAXTEXT],star_result[MAXTEXT],quotestr[2];
   char infilename[99],buf[3001],keyvec[50][100],keystar[100];
   ...
   zvmessage("asc2tcl version Sep 26, 2013 -  (64bit) - RJB"," ");
   ...
   if (infile == 0) {
      zvmessage("??E - Input file not found"," ");
      zabend();
   }
