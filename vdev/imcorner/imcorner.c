...
void main44(void)
{
   int i,j,status,pcount,pdef,inpcount,corrfoot;
   int nline1,nsamp1,nline2,nsamp2,thresh,labnl,labns;
   ...
   int cptr,*candl,*cands,sfirst,slast,ptl[4],pts[4],ptix[4];
   double mintop,minleft,minbot,minrt,linetop=0,samptop;
   double lineleft,sampleft=0,linebot=0,sampbot,linert,samprt=0;
