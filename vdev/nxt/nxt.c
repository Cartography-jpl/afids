#include <stdio.h>
#include <string.h>
//#include "taeconf.inp"    /* no longer needed 12-09-2012 *
#include "taeintproto.h"    /* formerly pgminc.inc - 12-09-2012 */
//#include "pgminc.inc"     /* no longer needed 12-09-2012 */
#include "vicmain_c.h"     /*  add .h or get message:                   */
...
//    char c;
    ...
    zifmessage("*** nxt - Dec 14, 2012 (mipl 64-bit) - RJB");
