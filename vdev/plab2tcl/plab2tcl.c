...
void main44(void)
{
   ...
   char property[100],keyword[100],key[33],valformat[9],vformat[9];
   
   zifmessage("plab2tcl version Wed Jan  2 2008");
   
   /* get the parameters */
   
   zvparm("property",property,&ct,&def,1,0);
      ...
      for (i=1;i<=nelement;i++)
         ...
         if (nelement==1)
            status=zlget(unit,"PROPERTY",key,char_result,
               ...
               "PROPERTY",property,"ULEN",133, NULL);
         else
