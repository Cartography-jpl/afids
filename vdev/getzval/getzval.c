...
void main44(void)
{
   ...
   int i_unit,*bptr,ll,lu,sl,su,llint,slint,icase,rejectcount,dted;
   int threject;
   short int **inbuf,*ptr,val,dval;
   char fmt_str[10];
   float spotfac;
   double *x,*y,*zval,*sigval;
   double woff,sum,wdiv,xfac,yfac,wmod,xfac2,yfac2,dx,dy,dist,rspot;
   double fac=0,val2;
   
   zifmessage("getzval version Fri Dec 28 2007");
