...
void main44(void)
{
	...
	zifmessage("mf version May 05, 2011 (64-bit) - RJB");
...
void process_function(ibis,function,code,nc)
int ibis;
int function;
int code;
int nc;
 ...
 */
char *nextcolnum(string,val,len,nc)
char *string;
int *val;
int *len;
int nc;
...
int parse_function_string(instring,fstring,pincol,ncol,outcol,opnum,nc)
char *instring;
char *fstring;
int *pincol;
int *ncol;
...
int replace_variable(fstring,varname,column)
char *fstring;
char *varname;
int column;
{
...
void convert_fstring(instring,fstring,pincol,ncol,nc)
char *instring;
char *fstring;
int *pincol;
int *ncol;
 ...
 *****************************************************************************
 *****************************************************************************/
void do_function_op(ibis, fstring, pincol, ncol, outcol,code)
int ibis;
char *fstring;
int *pincol;
int ncol;
...
void do_column_op(ibis, opnum,pincol,outcol )
int ibis;
int opnum;
int *pincol;
int outcol;
...
/**************************************************************/
void compute_stats(ibis,incol,nrow,mean,sig)
int ibis;
int incol;
int nrow;
float *mean;
...
/**************************************************************/
void compute_minmax(ibis,incol,nrow,minval,maxval)
int ibis;
int incol;
int nrow;
float *minval;
...
/**************************************************************/
void write_column_value(ibis,outcol,nrow,value)
int ibis;
int outcol;
int nrow;
float value;
...
/**************************************************************/
void write_column_sum(ibis,incol,outcol,nrow)
int ibis;
int incol;
int outcol;
int nrow;
...
/**************************************************************/
void write_column_diff(ibis,incol,outcol,nrow)
int ibis;
int incol;
int outcol;
int nrow;
