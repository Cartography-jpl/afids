...
/* prototype */
int above(double xp,double yp,double x1,double y1,double x2,double y2);
double pdist(double xp,double yp,double x1,double y1,double x2,double y2);
...
void main44(void)
{
   ...
   zifmessage("bowtie 10-08-2019 - rjb - 64-bit");
