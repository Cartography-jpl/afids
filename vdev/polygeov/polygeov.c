...
#include "carto/cartoGridUtils.h"
...
void main44(void)
{
   ...
   double tmaxx,tmaxy,tminx,tminy,x,y,*ptx,*pty;
   ...
   int i,j,k,n,ier,inpcnt,status,unit,colcount,ibis,clen,clen2,ptr,record;
   int irow,ntiepp,icnt,idef,nklsq,nlret;
   int ntri,gridnah,gridnav=0,pcount,pdef;
   int ttri,ttrj1,coldef,tiepdef;
   int ix,itri,tri,isign,ibisOut,ptr2;
   double eps,skinny,reject;
        
   zifmessage("polygeov version Fri Jan 11 2008");
