...
/*  printf("extended subheader data length (IXSHDL) = %ld\n", extended_subheader_data_length); */
...
/*printf("Ending pos of image subheader = %ld, Size of image subheader read = %ld\n", rc, rc - header_start);*/
...
/*  	printf ("first pixel expected to be found at %d\n", image_info[image_num].nitf_file_offset); */
