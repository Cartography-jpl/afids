...
#define MIN_SOUTH_LAT (-45.0*PI/180.0) /* alz was (-79.5*PI/180.0) */
#define MIN_EAST_NORTH 0
#define MAX_EAST_NORTH 8000000 /* alz was 4000000 */
...
const double UPS_False_Easting = 4000000; /* alz was 2000000 */
const double UPS_False_Northing = 4000000; /* alz was 2000000 */
static double UPS_Origin_Latitude = MAX_ORIGIN_LAT;  /*set default = North Hemisphere */
static double UPS_Origin_Longitude = (90.0*PI/180.0); /* alz was 0.0 */
 ...
 */
  ...
  if (Latitude < -MAX_LAT) Latitude = -MAX_LAT; /* alz added */
  if (Latitude > MAX_LAT) Latitude = MAX_LAT; /* alz added */
  ...
  if (Longitude < -PI) Longitude += (2 * PI);   /* alz added */
  if (Longitude > (2 * PI)) Longitude -= (2 * PI);   /* alz added */
