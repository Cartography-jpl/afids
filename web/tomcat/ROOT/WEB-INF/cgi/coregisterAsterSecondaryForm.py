...
#-*- coding: utf-8 -*-
"""
This program generates an OGS WPS query for aster secondary image coregistration.
"""
...
def main():
    ...
    print "<html><head><title>Aster Secondary Coregistration</title>"
    print "</head><body>"
    ...
    url = sc.schemeHostPort + "/cgi-bin/wps.py?service=Wps&version=0.4.0&request=execute&identifier=coregisterastersecondary&datainputs=prefix," + prefix + \
