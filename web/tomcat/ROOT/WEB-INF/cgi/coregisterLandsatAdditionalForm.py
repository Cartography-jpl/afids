...
#-*- coding: utf-8 -*-
"""
This program generates an OGS WPS query for landsat additional band image coregistration.
"""
...
def main():
    ...
    print "<html><head><title>Landsat Additional Band Coregistration</title>"
    print "</head><body>"
    ...
    fnamein = form[ 'fnamein' ].value
    gridtar = form[ 'gridtar' ].value
    ...
    url = sc.schemeHostPort + "/cgi-bin/wps.py?service=Wps&version=0.4.0&request=execute&identifier=coregisterlandsatadditional&datainputs=prefix," + prefix  + \
