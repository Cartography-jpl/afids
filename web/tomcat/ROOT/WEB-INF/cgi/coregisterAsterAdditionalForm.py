...
#-*- coding: utf-8 -*-
"""
This program generates an OGS WPS query for aster additional band image coregistration.
"""
...
def main():
    ...
    print "<html><head><title>Aster Additional Band Coregistration</title>"
    print "</head><body>"
    ...
    url = sc.schemeHostPort + "/cgi-bin/wps.py?service=Wps&version=0.4.0&request=execute&identifier=coregisterasteradditional&datainputs=prefix," + prefix  + \
